...
import {removeAllPizzas} from '../redux/actions/cart'
...
const Cart = () => {
  ...
  const addedPizzas = items && Object.keys(items).map(key => items[key].items[0]);
          ...
          : (
            <div className="cart">
              ...
              <div className="content__items">
                {
                  items && addedPizzas.map(pizza => (
                    <CartItem
                      key={pizza.id}
                      totalPizzasPrice={items[pizza.id].totalPizzasPrice}
                      pizzasCount={items[pizza.id].items.length}
                      {...pizza}
                    />
                  ))
                }
